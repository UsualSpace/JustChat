...
//CHAT RELATED ROUTES.
router.get("/chat/:chatID", middleware.AuthenticateSession); //Get general chat information. 
...
router.post("/chat/:chatID/censored-phrases/:phrase", middleware.AuthenticateSession, ); //Post a new censored phrase in the chat with chatID. 

router.delete("/chat/:chatID", middleware.AuthenticateSession, ); //Delete an existing chat with chatID.
router.delete("/chat/:chatID/censored-phrases/:phrase", middleware.AuthenticateSession, ); //Delete an existing censored phrase in the chat with chatID.
